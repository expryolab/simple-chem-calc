...
const Page = () => {
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <h1 className="text-2xl font-bold">L8表の使い方</h1>
      <p className="text-sm text-gray-600">
        このページでは、L8直交表ツールの使い方を順番に説明します。
      </p>

      <section className="space-y-2">
        <h2 className="text-lg font-semibold">L8直交表とは</h2>
        <p className="text-sm text-gray-700">
          L8直交表は、2水準の因子を最大7つまで、8回の実験（ラン）で効率よく評価できる実験計画法の表です。
      ...
      <section className="space-y-2">
        ...
        <ul className="list-disc ml-5 text-sm text-gray-700 space-y-1">
          <li>「因子を追加」ボタンで因子を増やせます（最大7つまで）。</li>
          <li>因子名、水準1のラベル（例：低）、水準2のラベル（例：高）を入力します。</li>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold">2. 実験計画（L8）を確認する</h2>
        <p className="text-sm text-gray-700">
          因子を登録すると、8回分の実験条件（各因子をどの水準で組み合わせて実験するか）が自動的に表示されます。
          この表の通りに8回の実験を行ってください。
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm text-gray-700">
          「実験結果の入力」セクションに、Run 1〜8それぞれで得られた結果（応答値）を数値で入力します。
          8つ全ての結果を入力すると、分散分析（ANOVA）が自動的に計算されます。
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <ul className="list-disc ml-5 text-sm text-gray-700 space-y-1">
          <li>平方和（SS）・自由度（df）・平均平方（MS）：統計的なばらつきの大きさを表す値です。</li>
          <li>寄与率：全体のばらつきのうち、その因子がどれくらいの割合を占めるかを示します。数値が大きいほど結果への影響が大きい因子です。</li>
          <li>
            効果：水準2の平均 − 水準1の平均。プラスなら水準2側が結果を大きくする方向に働いていることを意味します。
          </li>
        </ul>
        <p className="text-sm text-gray-700">
          さらに下の「各因子の水準別平均」では、因子ごとに水準1・水準2それぞれの平均値を確認できます。
        </p>
      </section>
